...
return Row(
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    try {
      ...
      final userPhone = authProvider.user!.phone.isNotEmpty
          ? authProvider.user!.phone
          : '9999999999';
      final userEmail = authProvider.user!.email.isNotEmpty
          ? authProvider.user!.email
          : null; // Will be generated by service
      final userName = authProvider.user!.name.isNotEmpty
          ? authProvider.user!.name
          : 'Customer';

      debugPrint('Creating payment order: orderId=$paymentOrderId, amount=${cartProvider.total}, phone=$userPhone, email=$userEmail, name=$userName');
      ...
      if (cashfreeOrder == null) {
        throw Exception('Failed to create payment order. Please check your internet connection and try again.');
      }
